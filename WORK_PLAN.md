...
| ID | Task | Dependencies | Acceptance Criteria |
|---|---|---|---|
| 3.3.1 | Define `FogOfWar` resource (explored tile set) | 3.1.4 | Resource holds `HashSet<IVec2>` of explored tiles. |
...
| ID | Task | Dependencies | Acceptance Criteria |
|---|---|---|---|
| 3.6.1 | Create `SpatialHash` utility | 1.1.3 | Utility for efficient proximity queries. |
| 3.6.2 | Spawn AI ships on map (world simulation placeholder) | 2.8.3 | AI ships exist on world map. |
...
| ID | Task | Dependencies | Acceptance Criteria |
|---|---|---|---|
| 4.4.1 | Create `PriceCalculationSystem` | 4.1.2 | Runs on world tick. |
...
| ID | Task | Dependencies | Acceptance Criteria |
|---|---|---|---|
| 5.4.1 | Allow player to own multiple ships | 2.2.5 | Player has list of owned ships. |
| 5.4.2 | Create Fleet Management UI | 5.4.1, 1.4.1 | Shows owned ships and their orders. |
| 5.4.3 | Allow issuing orders to owned ships | 5.4.2, 5.3.2 | UI to assign `TradeRoute`, `Patrol`, etc. |
